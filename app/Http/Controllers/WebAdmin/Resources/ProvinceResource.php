...
class ProvinceResource extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->back()->with('notify_success', 'Province added successfully');
        } catch (Exception $e) {
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->back()->with('notify_success', 'Province updated successfully');
        } catch (Exception $e) {
            return back()->with('notify_error', $e->getMessage());
        }
    }
