...
<form id="post_ad_form" action="{{route('edit-ad', $data['car']->id)}}" method="POST" enctype="multipart/form-data">
    {{csrf_field()}}
        ...
        <div class="container-xl">
            <div id="carinfo">
                    ...
                    <div class="col-md-6">
                        <div class="postad-select">
                            <select id="city" name="city">
                                ...
                                <option value="{{$city->id}}" @if($city->id == $data['car']->city_id) {{"selected"}} @endif>{{$city->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="row align-items-center mb-4">
                    ...
                    <div class="col-md-6">
                        <input class="form-control cinfo-field input-green" type="text" id="make_model_version"
                            placeholder="Make/Model/Version" readonly onclick="OpenCarInfoDialog()" value="{{$data['car']->make_model}}">
                    </div>
                    <div class="col-sm-1" id="tick_icon" > <img
                    ...
                    <div class="col-md-6">
                        <div class="postad-select">
                            <select id="car_registeration_city" name="car_registeration_city">
                                <option value="0">Select City</option>
                                @foreach ($data['cities'] as $city)
                                <option value="{{$city->id}}" @if($city->id == $data['car']->car_registeration_city) {{"selected"}} @endif>{{$city->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="postad-select">
                            <select class="remove_pointer_events" id="condition" name="condition">
                                <option value="USED" @if($data['car']->condition == "USED") {{"selected"}} @endif>Used</option>
                                <option value="NEW" @if($data['car']->condition == "NEW") {{"selected"}} @endif>Brand New</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="postad-select">
                            <select id="exterior_color" name="exterior_color">
                                ...
                                <option value="{{$color->id}}" @if($data['car']->exterior_color == $color->id) {{"selected"}} @endif>{{$color->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="input-group"> <span class="input-group-text inputlbl" id="basic-addon1">PKR</span>
                            <input type="number" class="form-control border-tl-0 border-bl-0" placeholder="Price"
                                ...
                                name="price" value="{{$data['car']->price_range}}">
                        </div>
                    </div>
                </div>
                <div class="row mb-4">
                    ...
                    <div class="col-md-6">
                        <textarea class="form-control" rows="5" placeholder="1000 Characters Maximum" id="description"
                            name="description" maxlength="1000">{{$data['car']->description}}</textarea>
                    </div>
                </div>
                <div class="row align-items-center mb-4">
                    <div class="col-xl-3 col-lg-3 col-md-4 text-md-end text-start mb-3 mb-md-0">
                    ...
                    <div class="col-md-6">
                        <div class="postad-select">
                            <select class="remove_pointer_events" id="engine_type" name="engine_type">
                                ...
                                <option value="{{$engine}}" @if($engine == $data['car']->engine_type) {{"selected"}} @endif>{{$engine}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="postad-select">
                            <select class="remove_pointer_events" id="transmission" name="transmission">
                                <option value="Automatic" @if("Automatic" == $data['car']->transmission) {{"selected"}} @endif>Automatic</option>
                                <option value="Manual" @if("Manual" == $data['car']->transmission) {{"selected"}} @endif>Manual</option>
                            </select>
                        </div>
                    </div>
                </div>
                <div class="row align-items-center mb-4">
                    ...
                    <div class="col-md-6">
                        <input type="number" class="form-control" placeholder="Select Capacity" id="engine_capacity"
                            name="engine_capacity" value="{{$data['car']->engine_capacity}}">
                    </div>
                </div>
                <div class="row align-items-center mb-4">
                    <div class="col-xl-3 col-lg-3 col-md-4 text-md-end text-start mb-3 mb-md-0">
                    ...
                    <div class="col-md-6">
                        <div class="postad-select">
                            <select class="remove_pointer_events" id="drive_type" name="drive_type">
                                ...
                                <option value="{{$drive}}" @if($drive == $data['car']->drive_type) {{"selected"}} @endif>{{$drive}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="postad-select">
                            <select class="remove_pointer_events" id="assembly" name="assembly">
                                <option value="Local" @if("Local" == $data['car']->assembly) {{"selected"}} @endif>Local</option>
                                <option value="Imported" @if("Imported" == $data['car']->assembly) {{"selected"}} @endif>Imported</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="postad-select">
                            <select id="car_registeration_year" name="car_registeration_year">
                                ...
                                @foreach ((new CommonController())->GetYearsList() as $year)
                                <option value="{{$year}}" @if($year == $data['car']->car_registeration_year) {{"selected"}} @endif>{{$year}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-md-6">
                                <label class="custom-checkbox mb-4 me-5"> {{$feature->name}}
                                    <input type="checkbox" id="feature" name="feature[]" value="{{$feature->id}}" @if($data['car']->list_feature->contains('name', $feature->name)) {{"checked"}} @endif> <span
            ...
            <div id="uploadphotos">
                ...
                <div class="upload-area mb-4" id="exterior_div_top">
                    ...
                    <div class="d-flex justify-content-md-center justify-content-start mb-5">
                        <div class="uploaded-img me-3"> <img src="{{URL::asset('front/images/img-icon.png')}}"> </div>
                        <div class="uploaded-action">
                            <label class="browsbtn btn btn-primary mb-2"> + Add Photos
                    ...
                    <div class="d-flex align-items-center mx-5 justify-content-center" hidden>
                        <div class="uploaded-box mx-1" @if($data['car']->exterior_images->count() < 1) style="display: none" @endif>
                            <img @if($data['car']->exterior_images->count() < 1) src="{{URL::asset('front/images/carsm.png')}}" @else src="{{$data['car']->exterior_images[0]->image}}" @endif
                             id="exterior_image_1" class="w-100"
                        ...
                        <div class="uploaded-box mx-1"  @if($data['car']->exterior_images->count() < 2) style="display: none" @endif>
                            <img @if($data['car']->exterior_images->count() < 2) src="{{URL::asset('front/images/carsm.png')}}" @else src="{{$data['car']->exterior_images[1]->image}}" @endif
                             id="exterior_image_2" class="w-100"
                        ...
                        <div class="uploaded-box mx-1"  @if($data['car']->exterior_images->count() < 3) style="display: none" @endif>
                            <img @if($data['car']->exterior_images->count() < 3) src="{{URL::asset('front/images/carsm.png')}}" @else src="{{$data['car']->exterior_images[2]->image}}" @endif
                             id="exterior_image_3" class="w-100"
                        ...
                        <div class="uploaded-box mx-1"  @if($data['car']->exterior_images->count() < 4) style="display: none" @endif>
                            <img @if($data['car']->exterior_images->count() < 4) src="{{URL::asset('front/images/carsm.png')}}" @else src="{{$data['car']->exterior_images[3]->image}}" @endif
                             id="exterior_image_4" class="w-100"
                        ...
                        <div class="uploaded-box mx-1"  @if($data['car']->exterior_images->count() < 5) style="display: none" @endif>
                            <img @if($data['car']->exterior_images->count() < 5) src="{{URL::asset('front/images/carsm.png')}}" @else src="{{$data['car']->exterior_images[4]->image}}" @endif
                             id="exterior_image_5" class="w-100"
                        ...
                        <div class="uploaded-box mx-1"  @if($data['car']->exterior_images->count() < 6) style="display: none" @endif>
                            <img @if($data['car']->exterior_images->count() < 6) src="{{URL::asset('front/images/carsm.png')}}" @else src="{{$data['car']->exterior_images[5]->image}}" @endif
                             id="exterior_image_6" class="w-100"
                ...
                <div class="upload-area mb-4" id="interior_div_top">
                    ...
                    <div class="d-flex align-items-center mx-5 justify-content-center" hidden>
                        <div class="uploaded-box mx-1" @if($data['car']->interior_images->count() < 1) style="display: none" @endif>
                            <img @if($data['car']->interior_images->count() < 1) src="{{URL::asset('front/images/carsm.png')}}" @else src="{{$data['car']->interior_images[0]->image}}" @endif
                             id="interior_image_1" class="w-100">
                        ...
                        <div class="uploaded-box mx-1" @if($data['car']->interior_images->count() < 2) style="display: none" @endif>
                            <img @if($data['car']->interior_images->count() < 2) src="{{URL::asset('front/images/carsm.png')}}" @else src="{{$data['car']->interior_images[1]->image}}" @endif
                             id="interior_image_2" class="w-100">
                        ...
                        <div class="uploaded-box mx-1" @if($data['car']->interior_images->count() < 3) style="display: none" @endif>
                            <img @if($data['car']->interior_images->count() < 3) src="{{URL::asset('front/images/carsm.png')}}" @else src="{{$data['car']->interior_images[2]->image}}" @endif
                             id="interior_image_3" class="w-100">
                        ...
                        <div class="uploaded-box mx-1" @if($data['car']->interior_images->count() < 4) style="display: none" @endif>
                            <img @if($data['car']->interior_images->count() < 4) src="{{URL::asset('front/images/carsm.png')}}" @else src="{{$data['car']->interior_images[3]->image}}" @endif
                             id="interior_image_4" class="w-100">
                        ...
                        <div class="uploaded-box mx-1" @if($data['car']->interior_images->count() < 5) style="display: none" @endif>
                            <img @if($data['car']->interior_images->count() < 5) src="{{URL::asset('front/images/carsm.png')}}" @else src="{{$data['car']->interior_images[4]->image}}" @endif
                             id="interior_image_5" class="w-100">
                        ...
                        <div class="uploaded-box mx-1" @if($data['car']->interior_images->count() < 6) style="display: none" @endif>
                            <img @if($data['car']->interior_images->count() < 6) src="{{URL::asset('front/images/carsm.png')}}" @else src="{{$data['car']->interior_images[5]->image}}" @endif
                             id="interior_image_6" class="w-100">
                ...
                <div class="upload-area mb-4" id="hotspot_div_top">
                    ...
                    <div class="d-flex align-items-center mx-5 justify-content-center" hidden>
                        <div class="uploaded-box mx-1" @if($data['car']->hotspot_images->count() < 1)  style="display: none" @endif>
                            <img @if($data['car']->hotspot_images->count() < 1) src="{{URL::asset('front/images/carsm.png')}}" @else src="{{$data['car']->hotspot_images[0]->image}}" @endif
                             id="hotspot_image_1" class="w-100">
                        ...
                        <div class="uploaded-box mx-1" @if($data['car']->hotspot_images->count() < 2) style="display: none" @endif>
                            <img @if($data['car']->hotspot_images->count() < 2) src="{{URL::asset('front/images/carsm.png')}}" @else src="{{$data['car']->hotspot_images[1]->image}}" @endif
                             id="hotspot_image_2" class="w-100">
                        ...
                        <div class="uploaded-box mx-1" @if($data['car']->hotspot_images->count() < 3) style="display: none" @endif>
                            <img @if($data['car']->hotspot_images->count() < 3) src="{{URL::asset('front/images/carsm.png')}}" @else src="{{$data['car']->hotspot_images[2]->image}}" @endif
                             id="hotspot_image_3" class="w-100">
                        ...
                        <div class="uploaded-box mx-1" @if($data['car']->hotspot_images->count() < 4) style="display: none" @endif>
                            <img @if($data['car']->hotspot_images->count() < 4) src="{{URL::asset('front/images/carsm.png')}}" @else src="{{$data['car']->hotspot_images[3]->image}}" @endif
                             id="hotspot_image_4" class="w-100">
                        ...
                        <div class="uploaded-box mx-1" @if($data['car']->hotspot_images->count() < 5) style="display: none" @endif>
                            <img @if($data['car']->hotspot_images->count() < 5) src="{{URL::asset('front/images/carsm.png')}}" @else src="{{$data['car']->hotspot_images[4]->image}}" @endif
                             id="hotspot_image_5" class="w-100">
                        ...
                        <div class="uploaded-box mx-1" @if($data['car']->hotspot_images->count() < 6) style="display: none" @endif>
                            <img @if($data['car']->hotspot_images->count() < 6) src="{{URL::asset('front/images/carsm.png')}}" @else src="{{$data['car']->hotspot_images[5]->image}}" @endif
                             id="hotspot_image_6" class="w-100">
            ...
            <div id="uploadphotos">
                ...
                <div class="upload-area mb-4">
                    <div class="d-flex justify-content-md-center justify-content-start">
                        <div class="me-3" id="video_content" @if($data['car']->video == "") style="display: none" @endif> <video
                                style=" width: 230px;height: 125px;" id="preview-business_image"
                                src="{{$data['car']->video}}" controls muted> </div>
                        <div class="uploaded-action">
                            <label class="browsbtn btn btn-primary mb-2"> + Add Video
                        ...
                        <div class="me-3" id="video_remove" @if($data['car']->video == "") style="display: none" @endif> <a
                                class="browsbtn btn btn-danger mb-2" href="javascript:RemoveVideo()"> - Remove Video
                            </a> </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-xl">
            <div id="contact-info">
                ...
                <div class="row align-items-center mb-4">
                    ...
                    <div class="col-xl-6 col-lg-7 col-md-7">
                        <input class="form-control priphone-field" type="text"
                            placeholder="{{(Session::get('user')->phone)?Session::get('user')->phone:'-'}}">
                    </div>
                </div>
                <div class="row align-items-center mb-5">
                    <div class="col-xl-3 col-lg-4 col-md-5 text-md-end text-start mb-3 mb-md-0">
                    ...
                    <div class="col-xl-6 col-lg-7 col-md-7">
                        <input class="form-control" type="text" placeholder="Secondary Number" id="secondary_number"
                            name="secondary_number" value="{{$data['car']->secondary_number}}">
                    </div>
                </div>
                <div class="d-flex justify-content-md-center justify-content-start mb-5 align-items-center">
                    ...
                    <label class="switch">
                        <input type="checkbox" name="whatsapp" @if($data['car']->whatsapp == "YES") {{"checked"}} @endif> <span class="slider round"></span> </label>
                </div>
            </div>
        </div>
    </section>
    ...
    <input type="hidden" name="car_year" id="car_year" value="{{$data['car']->car_year}}" />
    <input type="hidden" name="car_brand" id="car_brand" value="{{$data['car']->brand_id}}" />
    <input type="hidden" name="car_model" id="car_model" value="{{$data['car']->model_id}}" />
    <input type="hidden" name="car_version" id="car_version" value="{{$data['car']->version_id}}" />
</form>
@endsection
...
<script>
    var maxImages = 6;
    var exteriorChangeFlag = 0;
    var interiorChangeFlag = 0;
    var hotspotChangeFlag = 0;
function Submit (e)
{
    e.preventDefault();
    ...
    if($("#car_registeration_city").val() == "0")
    {
    ...
    if($("#exterior_image")[0].files.length == 0 && exteriorChangeFlag == 1)
    {
    ...
    else if($("#exterior_image")[0].files.length > 5 && exteriorChangeFlag == 1)
    {
    ...
    if($("#interior_image")[0].files.length == 0 && interiorChangeFlag == 1)
    {
    ...
    else if($("#interior_image")[0].files.length > 5 && interiorChangeFlag == 1)
    {
    ...
    if($("#hotspot_image")[0].files.length > 5 && hotspotChangeFlag == 1)
    {
...
function SelectModalVersion (version_id)
{
    ...
    $("#version"+model_id).children().addClass("active");
...
$('select').each(function(){
    ...
    for (var i = 0; i < numberOfOptions; i++) {
        ...
        if($this.children('option').eq(i).attr('selected'))
        {
            ...
            {
                $styledSelect.parent().addClass('input-green');
            }
    ...
    if($("#secondary_number").val() != "" && $("#secondary_number").val() != "+92__________")
    {
