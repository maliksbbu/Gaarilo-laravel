    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                ...
                {{csrf_field()}}
                <h2 class="modal-heading text-center my-3">Add Vehicle Type</h2>
                ...
                <div class="d-flex align-items-center justify-content-center mb-5">
                    <label class="white-space-nowrap me-2">Vehicle Type</label>
...
<div class="inner-content">
    <div class="d-flex align-items-center">
        <h4 class="page-heading my-4">Vehicle Type</h4>
        <button class="btn btn-primary ms-auto" data-bs-toggle="modal" data-bs-target="#add-vtype-popup">Add New Vehicle</button>
    </div>
            ...
            <div class="vtbox shadow-sm">
                <div class="align-items-center d-flex row w-100">
                    <div class="col-lg-10 mb-2 mb-lg-0">
                        <div class="d-flex align-items-center">
                            <img src="{{$vehicle->image}}" class="me-4 vmimg">
                            <span>{{$vehicle->name}}</span>
                        </div>
                    </div>
                    <div class="col-lg-2 text-end">
                        <div class=" my-2 d-inline-block me-4 me-lg-0">
                            <a href="javascript:OpenEditModal({{$vehicle->id}})">
                            <img src="{{URL::asset('admin-panel/images/edit.png')}}">
                            </a>
                        </div>
                        <div class="d-inline-block ms-3">
                            <form action="{{ route('admin.vehicle-type.destroy', $vehicle->id) }}" method="POST" id="delete_form_{{$vehicle->id}}">
                                {{ csrf_field() }}
                                <input type="hidden" name="_method" value="DELETE">

                                <a onclick="return confirm('Are you sure?')" href="javascript:Delete({{$vehicle->id}});">
                                    <img src="{{URL::asset('admin-panel/images/del.png')}}">
                                </a>
                            </form>
                        </div>
                        <div class="modal fade show popup-small" id="edit-vtype-popup_{{$vehicle->id}}" tabindex="-1" role="dialog">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <form action="{{route('admin.vehicle-type.update', $vehicle->id)}}" method="POST" >
                                            {{csrf_field()}}
                                            <input type="hidden" name="_method" value="PATCH">
                                            <h2 class="modal-heading text-center my-3">Edit Vehicle Type</h2>
                                            {{-- <div class="d-flex justify-content-md-center justify-content-start mb-5">
                                                <div class="uploaded-img me-3">
                                            ...
                                            <div class="d-flex align-items-center justify-content-center mb-5">
                                                <label class="white-space-nowrap me-2">Vehicle Type</label>
                                                <input type="text" class="form-control" id="name" name="name" placeholder="Vehicle Type" value="{{$vehicle->name}}">
                                            </div>
                                            <div class="text-center">
                                                <button data-bs-dismiss="modal" type="submit" class="btn btn-primary">Save</button>
                                            </div>
